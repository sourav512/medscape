export const Disease:any =[
    {
        ...
        "description": "A fungus that invades the tissue can cause a disease that's confined to the skin, spreads into tissue, bones and organs or affects the whole body.Symptoms depend on the area affected, but can include skin rash or vaginal infection resulting in abnormal discharge.",
        "common cause":"",
    ...
    },
    {
        ...
        "search" : "https://www.google.com/search?q=Peptic%20ulcer%20diseae",
        "description": "Ulcers occur when stomach acid damages the lining of the digestive tract. Common causes include the bacteria H. Pylori and anti-inflammatory pain relievers including aspirin.",
        "common cause": "",
    ...
    {
        "name": "AIDS",
        "search" : "https://www.google.com/search?q=AIDS",
        "description": "HIV damages the immune system and interferes with the body's ability to fight infection and disease. HIV can be spread through contact with infected blood, semen, or vaginal fluids. There's no cure for HIV/AIDS, but medications can control the infection and prevent disease progression.",
        "common cause": "",
    ...
    {
        "name": "Diabetes ",
        "search" : "https://www.google.com/search?q=Diabetes ",
        "description": "Diabetes is a chronic disease that occurs either when the pancreas does not produce enough insulin or when the body cannot effectively use the insulin it produce",
        "common cause": "excess body weight and physical inactivity",
        "treatment": "Diabetes can be treated with oral medicines (pills), insulin, and/or other injected medicines",
        "symptom":"Often, there are no symptoms. When symptoms do occur, they include excessive thirst or urination, fatigue, weight loss or blurred vision",
        "specialist" :"A diabetologist is a doctor who specialises in the diagnosis and treatment of diabetes"
    },
    {
        "name": "Gastroenteritis",
        "search" : "https://www.google.com/search?q=Gastroenteritis",
        "description": "Gastroenteritis is an inflammation of the lining of the stomach and intestines. The main symptoms include vomiting and diarrhea. It is usually not serious in healthy people, but it can sometimes lead to dehydration or cause severe symptoms.",
        "common cause": "",
    ...
    },
    {
        ...
        "search" : "https://www.google.com/search?q=Bronchial%20Asthma",
        "description": "Bronchial asthma is a chronic inflammatory disease of the airways characterized by bronchial hyperreactivity and a variable degree of airway obstruction.",
        "common cause": "",
    ...
    {
        "name": "Hypertension ",
        "search" : "https://www.google.com/search?q=Hypertension ",
        "description": "high blood pressure, also called hypertension, is blood pressure that is higher than normal. Your blood pressure changes throughout the day based on your activities. Having blood pressure measures consistently above normal may result in a diagnosis of high blood pressure (or hypertension).",
        "common cause": "",
    ...
    {
        "name": "Migraine",
        "search" : "https://www.google.com/search?q=Migraine",
    ...
    },
    {
        ...
        "search" : "https://www.google.com/search?q=Cervical%20spondylosis",
    ...
    },
    {
        ...
        "search" : "https://www.google.com/search?q=Paralysis%20(brain%20hemorrhage)",
        "description": "Brain bleeds – bleeding between the brain tissue and skull or within the brain tissue itself – can cause brain damage and be life-threatening. Some symptoms include headache; nausea and vomiting; or sudden tingling, weakness, numbness or paralysis of face, arm or leg",
        "common cause": "",
        "treatment": " Surgery can relieve pressure on your brain and repair torn arteries. Certain medications can help manage symptoms, such as painkillers to ease severe headaches",
        "symptom":"The blood from the hemorrhage can compress or displace vital brain tissue. A severe hemorrhage can cause a coma, or leave you paralyzed.",
    ...
    {
        "name": "Malaria",
        "search" : "https://www.google.com/search?q=Malaria",
    ...
    {
        "name": "Chicken pox",
        "search" : "https://www.google.com/search?q=Chickenpox",
        "description": "Chickenpox is an infection caused by the varicella-zoster virus. It causes an itchy rash with small, fluid-filled blisters. Chickenpox is highly contagious to people who haven't had the disease or been vaccinated against it.",
        "common cause": "",
    ...
    {
        "name": "Dengue",
        "search" : "https://www.google.com/search?q=Dengue",
        "description": "Dengue viruses are spread to people through the bite of an infected Aedes species (Ae. aegypti or Ae. albopictus) mosquito. Almost half of the world's population, about 4 billion people, live in areas with a risk of dengue",
        "common cause": "",
    ...
    {
        "name": "Typhoid",
        "search" : "https://www.google.com/search?q=Typhoid",
        "description": "Typhoid fever is an infection that spreads through contaminated food and water.Vaccines are recommended in areas where typhoid fever is common.Symptoms include high fever, headache, stomach pain, weakness, vomiting and loose stools.Treatment includes antibiotics and fluids.",
        "common cause": "",
    ...
    {
        "name": "hepatitis A",
        "search" : "https://www.google.com/search?q=hepatitis%20A",
        "description": "Hepatitis A is an inflammation of the liver caused by the hepatitis A virus (HAV). The virus is primarily spread when an uninfected (and unvaccinated) person ingests food or water that is contaminated with the faeces of an infected person.",
        "common cause": "",
    ...
    {
        "name": "Hepatitis B",
        "search" : "https://www.google.com/search?q=Hepatitis%20B",
        "description": "Hepatitis B is a vaccine-preventable liver infection caused by the hepatitis B virus (HBV). Hepatitis B is spread when blood, semen, or other body fluids from a person infected with the virus enters the body of someone who is not infected",
        "common cause": "",
    ...
    {
        "name": "Hepatitis C",
        "search" : "https://www.google.com/search?q=Hepatitis%20C",
        "description": "The virus is spread by contact with contaminated blood; for example, from sharing needles or from unsterile tattoo equipment.",
        "common cause": "",
    ...
    {
        "name": "Hepatitis D",
        "search" : "https://www.google.com/search?q=Hepatitis%20D",
        "description": "Hepatitis D only occurs amongst people who are infected with the Hepatitis B virus. Transmission requires contact with infectious blood. At-risk populations include intravenous drug abusers and men who have sex with men.",
        "common cause": "",
    ...
    {
        "name": "Hepatitis E",
        "search" : "https://www.google.com/search?q=Hepatitis%20E",
        "description": "The hepatitis E virus is mainly transmitted through drinking water contaminated with faecal matter.Symptoms include jaundice, lack of appetite and nausea. In rare cases, it may progress to acute liver failure.",
        "common cause": "",
    ...
    },
    {
        ...
        "search" : "https://www.google.com/search?q=Alcoholic%20hepatitis",
        "description": "Alcoholic hepatitis is inflammation of the liver caused by drinking alcohol. Alcoholic hepatitis is most likely to occur in people who drink heavily over many years. However, the relationship between drinking and alcoholic hepatitis is complex",
        "common cause": "",
    ...
    {
        "name": "Tuberculosis",
        "search" : "https://www.google.com/search?q=Tuberculosis",
    ...
    {
        "name": "Common Cold",
        "search" : "https://www.google.com/search?q=Common%20Cold",
    ...
    {
        "name": "Pneumonia",
        "search" : "https://www.google.com/search?q=Pneumonia",
    ...
    },
    {
        ...
        "search" : "https://www.google.com/search?q=Dimorphic%20hemmorhoids(piles)",
        "description": "Hemorrhoids, or piles, are a common issue. These swollen veins inside of your rectum or outside of your anus can cause pain, anal itching and rectal bleeding",
        "common cause": "",
    ...
    {
        "name": "Heart attack",
        "search" : "https://www.google.com/search?q=Heart%20attack",
        "description": "A heart attack is a medical emergency. A heart attack usually occurs when a blood clot blocks blood flow to the heart. Without blood, tissue loses oxygen and dies.",
        "common cause": "",
    ...
    {
        "name": "Varicose veins",
        "search" : "https://www.google.com/search?q=Varicose%20veins",
        "description": "Varicose veins are twisted, enlarged veins. Any vein that is close to the skin's surface (superficial) can become varicosed. Varicose veins most commonly affect the veins in the legs.",
        "common cause": "",
    ...
    {
        "name": "Hypothyroidism",
        "search" : "https://www.google.com/search?q=Hypothyroidism",
        "description": "Hypothyroidism's deficiency of thyroid hormones can disrupt such things as heart rate, body temperature and all aspects of metabolism. Hypothyroidism is most prevalent in older women.",
        "common cause": "",
    ...
    },
    {
        ...
        "search" : "https://www.google.com/search?q=Hyperthyroidism",
        "description": "Hyperthyroidism is the production of too much thyroxine hormone. It can increase metabolism. Symptoms include unexpected weight loss, rapid or irregular heartbeat, sweating and irritability, although the elderly often experience no symptoms.",
        "common cause": "",
    ...
    {
        "name": "Hypoglycemia",
        "search" : "https://www.google.com/search?q=Hypoglycemia",
        "description": "Hypoglycemia is a condition in which your blood sugar (glucose) level is lower than the standard range. Glucose is your body's main energy source. Hypoglycemia is often related to diabetes treatment.",
        "common cause": "",
    ...
    },
    {
        ...
        "search" : "https://www.google.com/search?q=Osteoarthristis",
    ...
    {
        "name": "Arthritis",
        "search" : "https://www.google.com/search?q=Arthritis",
    ...
    },
    {
        ...
        "search" : "https://www.google.com/search?q=(vertigo)%20Paroymsal%20Positional%20Vertigo",
        "description": "Benign paroxysmal positional vertigo (BPPV) is triggered by certain changes in head position, such as tipping the head up or down. It's rarely serious unless it increases the risk of falling.",
        "common cause": "",
    ...
    {
        "name": "Acne",
        "search" : "https://www.google.com/search?q=Acne",
    ...
    },
    {
        ...
        "search" : "https://www.google.com/search?q=Urinary%20tract%20infection",
        "description": "A urinary tract infection (UTI) is an infection in any part of the urinary system. The urinary system includes the kidneys, ureters, bladder and urethra. Most infections involve the lower urinary tract — the bladder and the urethra. Women are at greater risk of developing a UTI than are men.",
        "common cause": "",
        "treatment": "Antibiotics usually are the first treatment for urinary tract infections",
        "symptom":"A bladder infection may cause pelvic pain, increased urge to urinate, pain with urination and blood in the urine. A kidney infection may cause back pain, nausea, vomiting and fever.",
        "specialist" :"OBGYN Doctor"
    },
    {
        "name": "Psoriasis",
        "search" : "https://www.google.com/search?q=Psoriasis",
        "description": "Psoriasis is a skin disease that causes a rash with itchy, scaly patches, most commonly on the knees, elbows, trunk and scalp. Psoriasis is a common, long-term (chronic) disease with no cure. It can be painful, interfere with sleep and make it hard to concentrate",
        "common cause": "",
    ...
    {
        "name": "Impetigo",
        "search" : "https://www.google.com/search?q=Impetigo",
