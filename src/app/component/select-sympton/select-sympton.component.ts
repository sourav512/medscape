...
@Component({
  selector: 'app-select-sympton',
  templateUrl: './select-sympton.component.html',
  styleUrls: ['./select-sympton.component.scss']
})
export class SelectSymptonComponent implements OnInit {
